forward
global type n_cst_engineer_agreement_status_report from n_cst_report
end type
end forward
...
global n_cst_engineer_agreement_status_report n_cst_engineer_agreement_status_report
...
on n_cst_engineer_agreement_status_report.create
call super::create
end on

on n_cst_engineer_agreement_status_report.destroy
call super::destroy
end on
