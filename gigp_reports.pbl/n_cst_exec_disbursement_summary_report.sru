forward
global type n_cst_exec_disbursement_summary_report from n_cst_report
end type
end forward

global type n_cst_exec_disbursement_summary_report from n_cst_report
string dataobject = "d_exec_disbursement_summary_rpt"
end type
global n_cst_exec_disbursement_summary_report n_cst_exec_disbursement_summary_report
...
//	ld_award = f_get_project_amount(ll_gigpID, "RECFR")	
	...
	AND 		GA.gigp_id = :ll_gigpID
	AND	     0 < (select count(*)
						from gigp_key_dates
						where gigp_id = :ll_gigpID
						and ref_code = 'agreeAGRFULLEX'
						and keydate_value is not null);
...
ll_rowCount =This.Retrieve(ls_program, li_program, ii_round, idt_begin, idt_end, is_roundlist)
...
on n_cst_exec_disbursement_summary_report.create
call super::create
end on

on n_cst_exec_disbursement_summary_report.destroy
call super::destroy
end on
