forward
global type w_efc_reviewer_parms from w_report_parms
end type
type dw_parm from u_dw within w_efc_reviewer_parms
end type
type pb_selectall from picturebutton within w_efc_reviewer_parms
end type
type pb_deselectall from picturebutton within w_efc_reviewer_parms
end type
end forward
...
integer width = 1509
integer height = 1092
string title = "EFC Reviewers"
dw_parm dw_parm
pb_selectall pb_selectall
pb_deselectall pb_deselectall
end type
global w_efc_reviewer_parms w_efc_reviewer_parms
...
on w_efc_reviewer_parms.create
int iCurrent
call super::create
...
on w_efc_reviewer_parms.destroy
call super::destroy
...
type dw_1 from w_report_parms`dw_1 within w_efc_reviewer_parms
integer x = 297
integer y = 880
end type

type cb_cancel from w_report_parms`cb_cancel within w_efc_reviewer_parms
integer x = 1125
integer y = 868
end type

type cb_ok from w_report_parms`cb_ok within w_efc_reviewer_parms
integer x = 731
integer y = 868
end type
...
string dataobject = "dddw_efc_reviewers"
end type
