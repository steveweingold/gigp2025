forward
global type n_cst_accounting_status_report from n_cst_report
end type
end forward

global type n_cst_accounting_status_report from n_cst_report
string dataobject = "d_accounting_status_rpt"
end type
global n_cst_accounting_status_report n_cst_accounting_status_report
...
FOR ll_row = 1 TO ll_rowCnt
	...
	This.SetItem(ll_row, 'cc_netAvail', (ld_award - ld_disbursed))	
...
ll_rowCount = This.Retrieve(ls_recommendations, li_fundingrec, ls_program, li_program, ls_status, li_status, ii_round, idt_begin, idt_end, is_roundlist)
...
on n_cst_accounting_status_report.create
call super::create
end on

on n_cst_accounting_status_report.destroy
call super::destroy
end on
