forward
global type n_cst_design_review_report from n_cst_report
end type
end forward
...
global n_cst_design_review_report n_cst_design_review_report
...
String     ls_code[]     = {'readyPROJPLANSUB', 'readyPROJPLANAPRV', 'readyFINPLANSSUB', 'readyTARGETRVWDT', 'readyFINPLANSAPRV', 'regCERTSNTDEC', 'readyREGDECCERT', 'readySERPCERTSNTREG', 'readySERPCERTCOMPL', 'readyPROJPLANDEC'}
String     ls_dateCol[] = {'cc_engrptsubdt', 'cc_engrptapprvdt', 'cc_plansspecsubdt', 'cc_trgtrvwdt', 'cc_plansspecapprvdt', 'cc_certsentdecdt',  'cc_regdeccertdt', 'cc_serpcertsntregdt', 'cc_serpcertcompldt', 'cc_engrptapprvdecdt'}
String     ls_cmtsCol[] = {'cc_engrptsubcmt', 'cc_engrptapprvcmt', 'cc_plansspecsubcmt', 'DUMMY', 'cc_plansspecapprvcmt', 'DUMMY', 'DUMMY', 'DUMMY', 'DUMMY', 'cc_engrptapprvdeccmt'}
...
on n_cst_design_review_report.create
call super::create
end on

on n_cst_design_review_report.destroy
call super::destroy
end on
