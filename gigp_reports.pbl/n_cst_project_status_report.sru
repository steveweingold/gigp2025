forward
global type n_cst_project_status_report from n_cst_report
end type
end forward
...
global n_cst_project_status_report n_cst_project_status_report
...
public subroutine of_post_retrieve_report ();Long 		ll_rowCnt, ll_row, ll_gigpID
String 	ls_value, ls_projno
...
public subroutine of_open_parm_window ();OpenWithParm(w_funding_recommend_parms_proj_stat, 'MULTI')
end subroutine

on n_cst_project_status_report.create
call super::create
end on

on n_cst_project_status_report.destroy
call super::destroy
end on
