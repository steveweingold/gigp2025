forward
global type n_cst_disbursement_released_summary_report from n_cst_report
end type
end forward

global type n_cst_disbursement_released_summary_report from n_cst_report
string dataobject = "d_disbursement_released_summary_rpt"
end type
global n_cst_disbursement_released_summary_report n_cst_disbursement_released_summary_report
...
String ls_projNo, ls_formattedNo
...
// Changed to 4/1/2010 per A. Petrone - 01/24/2011
idt_begin = DateTime('04/01/2010')
...
on n_cst_disbursement_released_summary_report.create
call super::create
end on

on n_cst_disbursement_released_summary_report.destroy
call super::destroy
end on
