forward
global type n_cst_proofof_payment_notrec_sum_report from n_cst_report
end type
end forward

global type n_cst_proofof_payment_notrec_sum_report from n_cst_report
string dataobject = "d_proofof_payment_notrec_sum_rpt"
end type
global n_cst_proofof_payment_notrec_sum_report n_cst_proofof_payment_notrec_sum_report
...
on n_cst_proofof_payment_notrec_sum_report.create
call super::create
end on

on n_cst_proofof_payment_notrec_sum_report.destroy
call super::destroy
end on
