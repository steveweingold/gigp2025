forward
global type u_tabpg_closeout_items from u_tabpg_appinfo_base
end type
end forward

global type u_tabpg_closeout_items from u_tabpg_appinfo_base
string tag = "TAS Items"
integer height = 2000
string text = "Closeout"
string picturename = "PictureListBox!"
end type
global u_tabpg_closeout_items u_tabpg_closeout_items
...
on u_tabpg_closeout_items.create
call super::create
end on

on u_tabpg_closeout_items.destroy
call super::destroy
end on
...
type dw_1 from u_tabpg_appinfo_base`dw_1 within u_tabpg_closeout_items
integer x = 18
integer y = 12
integer width = 2821
integer height = 1968
string dataobject = "d_proj_project_closeout_dates"
end type
...
//	parent.of_add_notification(this.GetItemString(row, 'ref_description'), gnv_app.of_getuserid(), row)
//End If
