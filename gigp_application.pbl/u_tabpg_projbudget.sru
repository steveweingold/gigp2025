forward
global type u_tabpg_projbudget from u_tabpg_appinfo_base
end type
end forward

global type u_tabpg_projbudget from u_tabpg_appinfo_base
string tag = "Project Budget"
string text = "Budget"
string picturename = "Structure5!"
end type
global u_tabpg_projbudget u_tabpg_projbudget

on u_tabpg_projbudget.create
call super::create
end on

on u_tabpg_projbudget.destroy
call super::destroy
end on

event ue_addrow;call super::ue_addrow;
Long ll_newRow, ll_value, ll_sort
String ls_cat = "Miscellaneous"
...
dw_1.SetItem(ll_newRow, "ref_code",  "MISC")
dw_1.SetItem(ll_newRow, "sub_category",   ls_cat)
dw_1.SetItem(ll_newRow, "description",  ls_cat)
...
And sub_category = "Miscellaneous";
...
type dw_1 from u_tabpg_appinfo_base`dw_1 within u_tabpg_projbudget
...
If ( ib_editAccess = True) Then
	...
	//*************************************************************
	// All insert of Miscellaneous Budget Rows:
	//*************************************************************
...
Long ll_row, ll_gigpID, ll_amountID
//Decimal ld_budget, ld_approved
...
//*******************************************************
// Approved Amount cannot be greater than the Budgeted Amount:
// Rule removed 01/05/2010 - MPF
//*******************************************************	
//
//	ld_budget 		=	dw_1.GetItemDecimal(ll_row, "ref_amt")
//	ld_approved	= 	dw_1.GetItemDecimal(ll_row, "approved_amt")
//	
//	If (ld_approved > ld_budget) Then
//		Messagebox("ERROR!", "Approved Amount cannot be greater than the Budgeted Amount!")
//		Return -1
//	End If			
