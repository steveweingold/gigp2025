forward
global type u_tabpg_projdescription from u_tabpg_appinfo_base
end type
end forward
...
global u_tabpg_projdescription u_tabpg_projdescription

on u_tabpg_projdescription.create
call super::create
end on

on u_tabpg_projdescription.destroy
call super::destroy
end on

type dw_1 from u_tabpg_appinfo_base`dw_1 within u_tabpg_projdescription
