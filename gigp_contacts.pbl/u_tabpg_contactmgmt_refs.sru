forward
global type u_tabpg_contactmgmt_refs from u_tabpg_dbaccess
end type
end forward

global type u_tabpg_contactmgmt_refs from u_tabpg_dbaccess
string text = "Contact Refs"
string picturename = "SetDefaultClass!"
end type
global u_tabpg_contactmgmt_refs u_tabpg_contactmgmt_refs

on u_tabpg_contactmgmt_refs.create
call super::create
end on

on u_tabpg_contactmgmt_refs.destroy
call super::destroy
end on
...
type dw_1 from u_tabpg_dbaccess`dw_1 within u_tabpg_contactmgmt_refs
string dataobject = "d_contacts_master_refs"
end type
